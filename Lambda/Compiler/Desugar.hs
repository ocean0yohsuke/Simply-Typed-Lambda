module Lambda.Compiler.Desugar (
    makeLAMSugar,
    defToLambdaPairs, defsToCasePairs, newVars, 
    localMSPByPM,
) where
...
-- TODO: Lambda　Expr を返すべきか？
makeLAMSugar :: (PM, Type, SExpr) -> SExpr -> Lambda SExpr
makeLAMSugar (pm, ty, arg) s = do
